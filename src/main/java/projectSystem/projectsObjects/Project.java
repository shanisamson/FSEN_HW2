...
public class Project implements Subject {
    ...
    /**
     * Represetns the max number of students that can be registered to the project.
     */
    ...
    /**
     * List of observers (data manager and student) that needs to be notified when the status of this project is cahnged.
     */
